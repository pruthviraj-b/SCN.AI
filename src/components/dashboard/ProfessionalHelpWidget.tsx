            ...
            <div className="p-6 relative z-10">
                <div className="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <p className="text-xs text-blue-200/60">Direct access to expert guidance</p>
                    </div>
                ...
                <div className="space-y-3">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-white group-hover/item:text-white transition-colors">WhatsApp Support</span>
                        </div>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-white group-hover/item:text-white transition-colors">Instagram DM</span>
                        </div>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-white group-hover/item:text-white transition-colors">Email Us</span>
                        </div>
                ...
                <div className="mt-6 flex items-center justify-center gap-2 text-[10px] text-blue-200/50 uppercase tracking-widest">
